...
const { model } = require("../../models/resources/ManagePG.model");
...
router.get("/", (req, res) => {
  ...
  ManagePGModel.find()
    ...
    .catch((err) => {
      ...
      console.log(
        `ManagePG Model GET Error in file Manage.route.js --> ${err}`
      );
    });
});
...
router.post("/", (req, res) => {
  ...
  newItem
    ...
    .catch((err) => {
      ...
      console.log(
        `ManagePG Model POST Error in file Manage.route.js --> ${err}`
      );
    });
});
...
router.put("/:id", (req, res) => {
  ...
  ManagePGModel.findByIdAndUpdate({ _id: req.params.id }, editItem, {
    ...
    .catch((err) => {
      ...
      console.log(
        `ManagePG Model PUT Error in file Manage.route.js --> ${err}`
      );
    });
});
...
router.delete("/:id", (req, res) => {
  ManagePGModel.findByIdAndDelete(req.params.id)
    ...
    .catch((err) => {
      ...
      console.log(
        `ManagePG Model DELETE Error in file Manage.route.js --> ${err}`
      );
    });
});
